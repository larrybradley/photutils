...
Provides the heavy implementation of the windowed-centroid and
quadratic-fit-centroid lazyproperties as module-level helper functions.
The `SourceCatalog` lazyproperties stay slim wrappers that pass
``self`` into these helpers.
"""
...
def _compute_centroid_win(catalog):
    """
...
def _compute_cutout_centroid_quad(catalog):
    """
