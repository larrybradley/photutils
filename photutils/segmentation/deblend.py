...
def deblend_sources(data, segmentation_image, n_pixels, *, labels=None,
    ...
    contrast_method : {'basin', 'saddle'}, optional
        ...
        ``DEBLEND_MINCONT`` criterion, measures the significance of
        the peak itself independently of how much envelope territory
        it would inherit, and is faster because the watershed runs
        only once.
