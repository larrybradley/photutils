...
def make_batch_scene(*, seed=0):
    ...
    (neighbor-segment handling), sources touching every image edge
    (bbox clipping), masked pixels inside sources and spanning a
    close pair (mirror-correction rejection), and non-finite data
    values inside a source.
