...
def _mask_to_mirrored_value(data, replace_mask, xycenter, *, mask=None,
    ...
    mirroring correction in compiled code. It is kept as the
    pure-Python mirror of that correction and must track the
    compiled semantics exactly, which is enforced by the batch
