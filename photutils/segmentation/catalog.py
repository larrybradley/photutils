    ...
    **Scalar vs. Multi-source Catalogs**
    ...
    def _calc_kron_photometry(self, *, kron_params=None):
        ...
        for label, aperture, bkg in zip(labels, kron_aperture,
            ...
            kron_flag = 0
            # Flag an aperture bounding box that extends beyond the
            # data array. The box corners can have zero aperture
            # weight, so also require that a pixel with nonzero weight
