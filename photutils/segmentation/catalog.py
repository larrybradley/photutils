...
class SourceCatalog:
    ...
    progress_bar : bool, optional
        ...
        .. deprecated:: 3.1
           ...
           a future version. All property calculations are now
           computed for all sources at once in compiled code, so no
           progress bar is displayed and this keyword has no effect.
    ...
    **Scalar vs. Multi-source Catalogs**
    ...
    def _get_batch_arrays(self):
        ...
        shared by reference with sliced catalogs (see
        ``__getitem__``).
        ...
        if self._batch_arrays_cache is None:
            ...
            if self._error is not None:
                error = np.ascontiguousarray(self._error,
                                             dtype=np.float64)
