...
class ApertureStats:
    ...
    def _undefined_shape_mask(self):
        ...
        undefined or unreliable. A source with a positive net flux can
        still have second-order moments that are not positive
        semidefinite (e.g., from negative pixel values), which do not
        describe a shape. Its covariance-derived shape properties are
        NaN. A fully masked source has a zero net
